...
VOCAB: dict[str, list[str]] = {
    ...
    "artifact_focus": [
        ...
        "empirical_finding", "risk_assessment", "capability_profile",
        "policy_analysis", "framework_proposal", "eval_suite",
        "theoretical_contribution", "tool_release",
    ],
    "risk_domain": [
        ...
        "jailbreak_resistance", "self_preservation", "cyber_offense",
        "reward_hacking", "power_seeking", "autonomous_replication",
        "systemic_risk", "distributional_risk", "bio_risk", "alignment_tax",
    ],
    "method_tags": [
        ...
        "empirical_measurement", "interpretability_analysis",
        "framework_design", "policy_review", "theoretical_analysis",
        "survey_synthesis", "formal_verification",
    ],
