...
const routes = [
  {
    ...
    name: 'dashboard',
    component: Dashboard,
    meta: { title: '总览', icon: 'dashboard', group: '工作台' },
  },
  {
    path: '/works',
    name: 'works',
    component: Works,
    meta: { title: '文献库', icon: 'library', group: '工作台' },
  },
  {
    path: '/works/:id',
    name: 'work-detail',
    ...
    props: true,
    meta: { title: '文献详情', parent: 'works', group: '工作台' },
  },
  {
    path: '/pipeline',
    name: 'pipeline',
    component: PipelineView,
    meta: { title: '流程管理', icon: 'pipeline', group: '探索与处理' },
  },
  {
    path: '/topics',
    name: 'topics',
    component: TopicsReview,
    meta: { title: '主题闸门', icon: 'topics', group: '探索与处理' },
  },
  {
    path: '/ingest',
    name: 'ingest',
    component: IngestHub,
    meta: { title: '文献入库', icon: 'ingest', group: '探索与处理' },
  },
  {
    path: '/discovery',
    name: 'discovery',
    component: DiscoveryReview,
    meta: { title: '发现检索', icon: 'discovery', group: '探索与处理' },
  },
  {
    path: '/inbox',
    name: 'inbox',
    component: InboxReview,
    meta: { title: '收件箱', icon: 'inbox', group: '探索与处理' },
  },
  {
    path: '/intake',
    name: 'intake',
    component: IntakeReview,
    meta: { title: '采集审核', icon: 'intake', group: '审核与组织' },
  },
  {
    path: '/classification',
    name: 'classification',
    component: ClassificationReview,
    meta: { title: '分类审核', icon: 'classification', group: '审核与组织' },
  },
  {
    path: '/metadata',
    name: 'metadata',
    component: MetadataReview,
    meta: { title: '元数据审核', icon: 'metadata', group: '审核与组织' },
  },
  {
    path: '/duplicates',
    name: 'duplicates',
    component: Duplicates,
    meta: { title: '去重', icon: 'duplicates', group: '审核与组织' },
  },
  {
    path: '/relations',
    name: 'relations',
    component: Relations,
    meta: { title: '关系图', icon: 'relations', group: '审核与组织' },
  },
  {
    path: '/templates',
    name: 'templates',
    component: TemplateManage,
    meta: { title: '模板管理', icon: 'template', group: '设置' },
  },
  {
    path: '/:pathMatch(.*)*',
    name: 'not-found',
