...
const RISK_DOMAIN_OPTIONS = [
  ...
  { label: '欺骗与诚实', value: 'deception_honesty' },
  { label: '权力寻求', value: 'power_seeking' },
  { label: '监督规避', value: 'oversight_evasion' },
  { label: '情境感知', value: 'situational_awareness' },
  { label: '目标误泛化', value: 'goal_misgeneralization' },
  { label: '价值对齐', value: 'value_alignment' },
  { label: '多智能体安全', value: 'multi_agent_safety' },
